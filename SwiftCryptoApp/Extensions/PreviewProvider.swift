...
class DeveloperPreview {
    // making single instance with static
    ...
    let stats1 = StatisticModel(title: "marketCap", value: "$2.5Mn", percentageChange: 25.34)
    let stats2 = StatisticModel(title: "marketCap", value: "$45.5Bn")
